...
export function setDevInfoApi(data) {
  //系统-系统设置-基本信息-设置
  return axios.post('/api/web/setDevInfo', data)
}
export function getDevInfoApi(data) {
  //系统-系统设置-基本信息-获取
  return axios.post('/api/web/getDevInfo', data)
}

export function setDatetimeApi(data) {
  //系统-系统设置-时间配置-设置
  return axios.post('/api/web/setDatetime', data)
}
export function getDatetimeApi(data) {
  //系统-系统设置-时间配置-获取
  return axios.post('/api/web/getDatetime', data)
}

export function setStationConfigApi(data) {
  //系统-系统设置-站点信息-设置
  return axios.post('/api/web/setStationConfig', data)
}
export function getStationConfigApi(data) {
  //系统-系统设置-站点信息-获取
  return axios.post('/api/web/getStationConfig', data)
}

export function setSentreServerApi(data) {
  //系统-系统设置-中心服务-设置(对接完成)
  return axios.post('/api/web/setCentreServer', data)
}
export function getSentreServerApi(data) {
  //系统-系统设置-中心服务-获取（对接完成）
  return axios.post('/api/web/getCentreServer', data)
}

export function rebootApi(data) {
  //系统-系统维护-重启
...
export function setDiskInfoApi(data) {
  //磁盘配置-设置
  return axios.post('/api/web/setDiskInfo', data)
}
export function getDiskInfoApi(data) {
  // 磁盘配置-获取
  return axios.post('/api/web/getDiskInfo', data)
}

//------------------------------------相机------------------------------------------------
export function addCameraApi(data) {
  //添加相机
  let {
    ip,
    port,
  ...
  return axios.post('/api/web/cameraAdd', {
    deviceIp: ip,
    devicePort: port,
    name,
    url,
    ...
    videoW,
    videoH,
  }) // ,status,ImageUrl,IsDelete,EditFlag,PlayUrl,InsType
}
export function editCameraApi(data) {
  // 修改相机
  let {
    ip,
    port,
  ...
  return axios.post('/api/web/cameraUpdate', {
    deviceIp: ip,
    devicePort: port,
    id,
    name,
    ...
    RuleId,
    GroupIds,
  }) //{id,name,url,remark,videoW,videoH}
}
export function delCameraApi(data) {
  // 删除相机
  let { id, channelId } = data
  return axios.post('/api/web/cameraDelete', { id, channelId })
}
export function getCameraApi(data) {
  // 获取相机
...
export function getOsdInfoApi(data) {
  //OSD 参数-获取
  let { id } = data
  return axios.post('/api/web/getOsdConfig', { id })
}
export function setOsdInfoApi(data) {
  // OSD 参数-设置
...
export function getAlgorithmApi(data) {
  //算法-获取(这里新接口对接完成)
  let { id } = data
  return axios.post('/api/web/getAlgInfo', { id })
}
export function setAlgorithmApi(data) {
  //算法-设置(这里新接口对接完成)
  let { id, AlgInfos } = data
  return axios.post('/api/web/setAlgInfo', { id: id, algInfos: AlgInfos })
}

export function getAlgorithmListApi(data) {
  //获取算法列表(这里新接口对接完成)-------------------
  let { id = '', name = '', path = '' } = data
  //
  return new Promise((resolve, reject) => {
    axios
      .post('/api/web/getAlgorithm', { id, name, path })
      .then((res) => {
        if (res.code == 0) {
...
export function addAlgorithmApi(data) {
  //添加算法列表(这里新接口对接完成)-------------------
  let {
    name,
    path,
  ...
  return axios.post('/api/web/addAlgorithm', {
    name,
    path,
    alarmNumber,
    Canuse,
...
export function setAlgorithmListApi(data) {
  //修改算法列表(这里新接口对接完成)-------------------
  let {
    id,
    name,
  ...
  return axios.post('/api/web/setAlgorithm', {
    id,
    name,
    path,
    alarmNumber,
...
export function deleteAlgorithmApi(data) {
  //删除算法列表(这里新接口对接完成)-------------------
  let { id } = data
...
export function userAddApi(data) {
  ...
  return axios.post('/api/web/userAdd', {
    userName,
    pwd,
    createTime,
    rolerList,
...
//-------------------------------------------------------------------------日志-------------------------------------------------------------------------
export function modelOptionsApi(data) {
  //模块下拉
  return axios.post('/api/web/modelOptions', objFc('modelOptions', data))
}
export function historyLogApi(data) {
  //历史日志
...
export function getAlarmHisApi(data) {
  //获取报警数据
  let { cameraId, startTime, endTime, alarmType, curPage, pageNum } = data
  return axios.post('/api/web/getAlarmHis', {
    cameraId,
    startTime,
    endTime,
    alarmType,
...
export function getFaceAlarms(data) {
  //人脸识别
  return axios.post('api/web/getFaceAlarms', data)
}

export function downloadAlarmHisApi(data) {
  //下载
  let { cameraId, startTime, endTime, alarmType, download, userId = '' } = data
  return axios.post('/api/web/downloadAlarmHis', {
    cameraId,
    startTime,
    endTime,
    alarmType,
...
export function deleteAlarmHisApi(userId) {
  //删除
  return axios.post('/api/web/deleteAlarmHis', { userId })
}
export function downloadAlarmHisReadyApi(data) {
  //轮询
...
// ------------------------------------------------------------大屏接口------------------------------------------------------------
export function getAlarmInfoCountApi(data) {
  //获取今日报警数据和本月top排名
  let { TimeType = 'day' } = data
  return new Promise((resolve, reject) => {
    axios
      .post('/api/web/getAlarmInfoCount', { TimeType })
      .then((res) => {
        if (res.code == 0) {
          res.data = greenroom(res.data)
        }
...
export function getAlarmCountApi(data) {
  //获取七日内统计数据
...
export function getEngineGetApi() {
  //获取引擎信息
  return axios.post('/api/web/getAlgorithmConfig', {})
}
export function getEngineUpdateApi(data) {
  //修改引擎信息
...
//-------------------------------------------------------------------------websocket发送ws-------------------------------------------------------------------------
export function wsPreview(callback, data) {
  //预览websocket
  return axios.ws('/ws', callback, data) //返回的就是一个ws对象可以进行操作
}
export function wsCpu(callback, data) {
  //cpu  websocket  系统中的系统设置中
  return axios.ws('/ws', callback, data) //返回的就是一个ws对象可以进行操作记得页面销毁的时候要注销ws
}
export function wsLog(callback, data) {
  //发送日志
  return axios.ws('/ws', callback, data) //返回的就是一个ws对象可以进行操作记得页面销毁的时候要注销ws
}
