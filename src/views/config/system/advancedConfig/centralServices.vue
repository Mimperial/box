  ...
  <div class="limian" :style="{ width: width }">
    ...
    >
      ...
      >
        ...
        <el-radio v-model="ruleForm.status" :label="false">无</el-radio>
        <el-radio v-model="ruleForm.status" :label="true">接入知云</el-radio>
      </el-form-item>
      <el-form-item
      ...
      >
        <el-tooltip
          :content="ruleForm.flagVod ? $t('html.kq') : $t('html.gb')"
          placement="top"
        >
          <el-switch v-model="ruleForm.flagVod"> </el-switch>
        </el-tooltip>
